...
public interface IAvailabilityService
{
    ...
    /// <summary>Retorna todos os slots do dia com flag disponível/ocupado. employeeId filtra por funcionário específico; null = qualquer (respeita capacidade do negócio).</summary>
    Task<IReadOnlyList<SlotWithAvailabilityDto>> GetSlotsWithAvailabilityAsync(Guid businessId, Guid serviceId, DateTime date, int slotIntervalMinutes = 30, Guid? employeeId = null, CancellationToken cancellationToken = default);
}
